 ...
 *
 * Disassembly of SSDT-10-Wwan.aml, Sun Jan 26 23:58:07 2020
 *
    ...
    Scope (\_SB.PCI0.RP12)
    {
        ...
        Scope (PXSX)
        {
            Method (_RST, 0, Serialized)  // _RST: Device Reset
            {
                ...
                If (LEqual (NEXP, Zero))
                {
                    Store (\WDCT, DCTL) /* \_SB_.PCI0.RP12.PXSX._RST.DCTL */
                    Store (\WLCT, LCTL) /* \_SB_.PCI0.RP12.PXSX._RST.LCTL */
                    Store (\WDC2, DCT2) /* \_SB_.PCI0.RP12.PXSX._RST.DCT2 */
                    Store (\WMXS, MXSL) /* \_SB_.PCI0.RP12.PXSX._RST.MXSL */
                    Store (\WMNS, MNSL) /* \_SB_.PCI0.RP12.PXSX._RST.MNSL */
                }
