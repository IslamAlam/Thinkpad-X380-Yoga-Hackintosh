 ...
 *
 * Disassembly of SSDT-4-ProjSsdt.aml, Sun Jan 26 23:58:07 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "ProjSsdt", 0x00000010)
{
    ...
    Scope (\)
    {
        ...
        {
            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 0008 */  0xA9, 0x12, 0x80, 0x00, 0x03, 0x00, 0x00, 0x00   // ........
        })
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS04)
    {
        ...
        {
            Name (PLDP, Buffer (0x10){})
            Store (\PLDI, PLDP) /* \_SB_.PCI0.XHC_.RHUB.HS04._PLD.PLDP */
    ...
    Scope (\_SB.PCI0.XHC.RHUB.SS02)
    {
        Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
        {
            ...
            CopyObject (\UPCI, UPCP) /* \_SB_.PCI0.XHC_.RHUB.SS02._UPC.UPCP */
        ...
        {
            Name (PLDP, Buffer (0x10){})
            Store (\PLDI, PLDP) /* \_SB_.PCI0.XHC_.RHUB.SS02._PLD.PLDP */
    ...
    Scope (\_SB.PCI0.XHC.RHUB.SS03)
    {
        ...
        {
            Name (PLDP, Buffer (0x10){})
            Store (\PLD2, PLDP) /* \_SB_.PCI0.XHC_.RHUB.SS03._PLD.PLDP */
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS04.WCAM)
    {
        Method (_STA, 0, NotSerialized)  // _STA: Status
        {
            If (\WIN8)
